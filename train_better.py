...
def main(cfg):
    ...
    if cfg.data.dataset_name == 'DDSM':
        ...
        val_dataset = DDSM_dataset(cfg.data.root, view_laterality=cfg.data.laterality, split='val', transform=train__valid_transform)
    elif cfg.data.dataset_name == 'ThongNhat':
        train_dataset = ThongNhat_dataset(cfg.data.root, view_laterality=cfg.data.laterality, split='train', transform=train__valid_transform)
        val_dataset = ThongNhat_dataset(cfg.data.root, view_laterality=cfg.data.laterality, split='val', transform=train__valid_transform)
    elif cfg.data.dataset_name == 'VinDr':
        train_dataset = VinDr_dataset(cfg.data.root, view_laterality=cfg.data.laterality, split='train', transform=train__valid_transform)
        val_dataset = VinDr_dataset(cfg.data.root, view_laterality=cfg.data.laterality, split='val', transform=train__valid_transform)
